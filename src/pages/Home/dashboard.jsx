...
const Dashboard = () => {
  ...
  const getData = async () => {
    ...
    await axios
      .get("https://itrepeats-backend-2p5h.vercel.app/api/question-paper/get-details")
      .then((res) => {
  ...
  const deleteQP = async (e) => {
    let qid = e;
    await axios
      .delete(`https://itrepeats-backend-2p5h.vercel.app/api/question-paper/delete/${qid}`)
      .then((res) => {
        console.log(res);
      })
      .catch((err) => {
  ...
  const getCourses = async () => {
    ...
    await axios
      .get(
        `https://itrepeats-backend-2p5h.vercel.app/api/question-paper/get-sub?DepartmentName=${details.depart}&Semester=${details.sem}`
      )
      .then((res) => {
        console.log(res.data.data);
        try {
